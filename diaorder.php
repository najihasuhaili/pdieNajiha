...
<div class="container">
    <h2 class="text-center">ORDER FORM FOR DIA STUDENT</h2>
    <div class="row">
      <div class="center-content">
        <div class="col-md-8">
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submitOrder'])) {
                ...
                $insertSql = "INSERT INTO diaorder (studentId, studentName, bookName, status) VALUES ('$studentId', '$studentName', '$selectedBooks', '$status')";
            ...
            <form action='' method='POST' class="well">
                ...
                <div class="form-group">
                    ...
                    $arahan_sql = "SELECT bookName FROM dialist";
