...
if (isset($_GET['dlhCode'])) {
    $dlhCode = $_GET['dlhCode'];
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $update_sql = "UPDATE dlhlist SET dlhSem='$newSemester', bookName='$newBookName', price='$newPrice' WHERE dlhCode='$dlhCode'";
        if (mysqli_query($condb, $update_sql)) {
            // Redirect back to the main page after updating
            header('Location: adminDlhBookList.php');
            exit();
        } else {
        ...
        $select_sql = "SELECT * FROM dlhlist WHERE dlhCode='$dlhCode'";
            ...
            <div class="container">
                ...
                <form method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="newSemester" value="<?php echo $row['dlhSem']; ?>">
                    </div>
                    <div class="form-group">
