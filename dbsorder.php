...
<body>
<ul>
  <li><a class="active" href="dbsorder.php">Order Books</a></li>
  <li><a href="dbsTrack.php">Track Order</a></li>
  <li><a href="course.php">Course</a></li>
  <li><a href="index.php">Log out</a></li>
</ul>

<div class="container">
    <h2 class="text-center">ORDER FORM FOR DBS STUDENT</h2>
    <div class="row">
      <div class="center-content">
        <div class="col-md-8">
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submitOrder'])) {
                ...
                $insertSql = "INSERT INTO dbsorder (studentId, studentName, bookName, status) VALUES ('$studentId', '$studentName', '$selectedBooks', '$status')";
            ...
            <form action='' method='POST' class="well">
                ...
                <div class="form-group">
                    ...
                    $arahan_sql = "SELECT bookName FROM dbslist";
