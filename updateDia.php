...
if (isset($_GET['diaCode'])) {
    $diaCode = $_GET['diaCode'];
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $update_sql = "UPDATE dialist SET diaSem='$newSemester', bookName='$newBookName', price='$newPrice' WHERE diaCode='$diaCode'";
        if (mysqli_query($condb, $update_sql)) {
            // Redirect back to the main page after updating
            header('Location: adminDiaBookList.php');
            exit();
        } else {
        ...
        $select_sql = "SELECT * FROM dialist WHERE diaCode='$diaCode'";
            ...
            <div class="container">
                ...
                <form method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="newSemester" value="<?php echo $row['diaSem']; ?>">
                    </div>
                    <div class="form-group">
